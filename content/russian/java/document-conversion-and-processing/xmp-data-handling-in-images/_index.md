...
Для получения более общей информации, такой как автор, название и дополнительные значения, создайте пакет DublinCore и установите его атрибуты. Добавьте этот пакет также в метаданные XMP.
