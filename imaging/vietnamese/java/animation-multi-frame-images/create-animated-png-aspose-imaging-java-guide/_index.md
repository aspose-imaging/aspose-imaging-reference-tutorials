...
A4: Xác minh đường dẫn tệp và đảm bảo tất cả các phụ thuộc được cấu hình đúng. Tham khảo [Hỗ trợ Aspose](https://forum.aspose.com/c/imaging/14) nếu vấn đề vẫn tiếp diễn.
