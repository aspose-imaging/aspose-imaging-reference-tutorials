...
A4: Проверьте пути к файлам и убедитесь, что все зависимости настроены правильно. Проконсультируйтесь [Поддержка Aspose](https://forum.aspose.com/c/imaging/10) если проблемы сохраняются.
